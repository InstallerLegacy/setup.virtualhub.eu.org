...
VirtualHub Setup is a static site and it is fast. While VirtualHub is build using [Jekyll](https://jekyllrb.com/), this site is build using [hugo](https://gohugo.io/).
